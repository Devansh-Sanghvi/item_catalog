...
2.)git clone 'https://github.com/Devansh-Sanghvi/item_catalog.git' and cd item_catalog
...
/categories/<int:category_id>/<int:item_id>/JSON
...
Category Item JSON: `/categories/<int:category_id>/JSON`
